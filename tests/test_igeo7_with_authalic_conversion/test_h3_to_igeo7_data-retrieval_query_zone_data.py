...
def test_h3_to_h3_data_retrieval():
    ...
    response = client.get(f'/dggs-api/dggs/non_exist/zones/{non_exists[0]}/data')
    ...
    response = client.get(f"/dggs-api/dggs/h3/zones/{zone['zoneid']}/data", params={"zone-depth": over_rf_depth})
    ...
    response = client.get(f'/dggs-api/dggs/h3/zones/{zone["zoneid"]}/data')
    ...
    response = client.get(f'/dggs-api/dggs/h3/zones/{zone["zoneid"]}/data', headers={'accept': 'application/geo+json'},
                          params={'zone-depth': '0'})
    assert response.status_code == 200
    ...
    response = client.get(f'/dggs-api/dggs/h3/zones/{zone["zoneid"]}/data', params={'geometry': 'zone-centroid', 'zone-depth': '0'},
    ...
    response = client.get(f'/dggs-api/dggs/h3/zones/{zone["zoneid"]}/data', params={'zone-depth': '2'})
    data = ZonesDataDggsJsonResponse(**response.json())
    assert response.status_code == 200
    for k, v in data.values.items():
        assert len(v) == 1
    ...
    response = client.get(f'/dggs-api/dggs/h3/zones/{zone["zoneid"]}/data', params={'zone-depth': '1-2'})
    data = ZonesDataDggsJsonResponse(**response.json())
    assert response.status_code == 200
    ...
    response = client.get(f'/dggs-api/dggs/h3/zones/{zone["zoneid"]}/data', params={'zone-depth': '0-2'})
    data = ZonesDataDggsJsonResponse(**response.json())
    assert response.status_code == 200
    ...
    response = client.get(f'/dggs-api/dggs/h3/zones/{zone["zoneid"]}/data', params={'zone-depth': '0-2', 'geometry': 'zone-centroid'},
                          headers={'accept': 'application/geo+json'})
    data = ZonesDataGeoJson(**response.json())
    assert len(data.features) > 0
    assert response.status_code == 200
    ...
    response = client.get(f'/dggs-api/dggs/h3/zones/{non_exists[0]}/data', params={'zone-depth': '0-2', 'geometry': 'zone-centroid'},
                          headers={'accept': 'application/geo+json'})
